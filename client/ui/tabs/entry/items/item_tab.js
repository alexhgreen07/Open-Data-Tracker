define([
	...
	function Item_Tab() {
		 ...
		 * */
		this.edit_item_entry_form = new edit_item_entry_form.Edit_Item_Entry_Form();
		 ...
		 * @type Edit_Item_Form
		 * */
		this.edit_item_form = new edit_item_form.Edit_Item_Form();
		
		/** This is the new item targets form object.
		 * @type New_Item_Target_Form
		 * */
		this.new_item_target_form = new new_item_target_form.New_Item_Target_Form();
