define([
	...
	function New_Task_Entry_Form(){
		...
		this.Insert_Task_Entry = function(is_completed) {
			...
			var selected_index = this.add_task_entry_task_name_select.selectedIndex;
			...
			if (selected_index > 0) {
				...
				var task_time = $(this.task_entry_start_time).datetimepicker('getDate');
				var duration = $(this.task_entry_duration).val();
				var task_note = $(this.task_entry_note).val();
				var task_status = $(this.add_task_entry_task_status_select).val();
				...
				app.api.Task_Data_Interface.Insert_Task_Entry(params, function(jsonRpcObj) {
					...
					if (jsonRpcObj.result.success) {
						...
						$(self.task_entry_duration).val('0');
						$(self.task_entry_note).val('');
		...
		this.Render = function(parent_div) {
			...
			this.data_form_new_entry = parent_div.appendChild(this.data_form_new_entry);

			this.data_form_new_entry.appendChild(document.createTextNode('Tasks:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.add_task_entry_task_name_select = this.data_form_new_entry.appendChild(this.add_task_entry_task_name_select);
			
			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createTextNode('Target:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.task_target_select = this.data_form_new_entry.appendChild(this.task_target_select);

			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createTextNode('Start Time:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.task_entry_start_time = this.data_form_new_entry.appendChild(this.task_entry_start_time);
			
			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createTextNode('Status:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.add_task_entry_task_status_select = this.data_form_new_entry.appendChild(this.add_task_entry_task_status_select);

			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createTextNode('Duration:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.task_entry_duration = this.data_form_new_entry.appendChild(this.task_entry_duration);

			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createTextNode('Note:'));
			this.data_form_new_entry.appendChild(document.createElement('br'));
			...
			this.task_entry_note = this.data_form_new_entry.appendChild(this.task_entry_note);
			...
			this.add_task_entry_task_submit_button = this.data_form_new_entry.appendChild(this.add_task_entry_task_submit_button);

			this.data_form_new_entry.appendChild(document.createElement('br'));
			this.data_form_new_entry.appendChild(document.createElement('br'));

			$(this.add_task_entry_task_submit_button).button();
			$(this.add_task_entry_task_submit_button).click(function(event) {
			...
			$(this.task_entry_start_time).datetimepicker({
				timeFormat : "HH:mm:ss",
				dateFormat : 'yy-mm-dd'
			});
			$(this.task_entry_start_time).datetimepicker("setDate", new Date());

		};
	}
	
	function Build_New_Task_Entry_Form()
	{
		var built_new_task_entry_form = new New_Task_Entry_Form();
		
		return built_new_task_entry_form;
	}
	
	return {
		Build_New_Task_Entry_Form: Build_New_Task_Entry_Form,
		New_Task_Entry_Form: New_Task_Entry_Form,
	};
});
