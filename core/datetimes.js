define([],function(){
	return {
		Cast_Server_Datetime_to_Date: function(server_datetime_string)
		{
			
			return new Date(server_datetime_string);
		},
		Cast_Date_to_Server_Datetime: function(date_object)
		{
			
			return date_object.toISOString();
		},
		Convert_UTC_Date_To_Local_Timezone: function (utc_date_object)
		{
		...
		Convert_Local_Date_To_UTC_Timezone: function (local_date_object)
		{
			var current_date = new Date();
		...
		Cast_Local_Server_Datetime_To_UTC_Server_Datetime: function (local_datetime_string)
		{
		...
		Get_String_From_Time_Interval: function (time_interval1, time_interval2)
		{
